...
// KEYWORD2-NEXT:             Keyword/None:                       unavailableFromAsync[#Func Attribute#]; name=unavailableFromAsync
...
// ON_INIT-DAG: Keyword/None:                       unavailableFromAsync[#Constructor Attribute#]; name=unavailableFromAsync
...
// ON_METHOD-DAG: Keyword/None:                       unavailableFromAsync[#Func Attribute#]; name=unavailableFromAsync
...
// ON_MEMBER_LAST-DAG: Keyword/None:                       unavailableFromAsync[#Declaration Attribute#]; name=unavailableFromAsync
...
// KEYWORD_LAST-DAG: Keyword/None:                       unavailableFromAsync[#Declaration Attribute#]; name=unavailableFromAsync
