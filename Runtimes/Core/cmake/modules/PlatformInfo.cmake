if(NOT SwiftCore_SIZEOF_POINTER)
  ...
  message(CONFIGURE_LOG "Stdlib Pointer size: ${ptr_bytes}")
  set(SwiftCore_SIZEOF_POINTER "${ptr_bytes}" CACHE STRING "Size of a pointer in bytes")
...
if(NOT SwiftCore_SWIFTC_CLANGIMPORTER_RESOURCE_DIR)
  ...
  set(SwiftCore_SWIFTC_CLANGIMPORTER_RESOURCE_DIR "${resource_dir}" CACHE STRING "Swift clang-importer resource directory")
